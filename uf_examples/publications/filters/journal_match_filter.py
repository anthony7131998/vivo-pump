...
def publisher_name_filter(input_publisher):
    ...
    print_err("publisher is: {}".format(input_publisher))
...
count_new_journals = 0

for row, data in data_in.items():
    data_out[row] = data

    print_err("Journal is: {} \t issn is: {}".format(data['name'],data['issn']))
...
print_err("New journals to add: {}".format(count_new_journals))
